...
public class MannerCheckListDTO {
    ...
    public MannerCheckListDTO(Boolean goodPrice, Boolean goodTime, Boolean fastResponse, Boolean badQuality, Boolean noResponse, Long buyerId, Long sellerId, Long post_id, Integer mannerScore) {
